...
from .views import post_list_view, post_detail_view, create_post_view, delete_post_view, toggle_like_view, delete_comment_view, toggle_upvote_comment
...
urlpatterns = [
    ...
    path('comment/<int:pk>/toggle_upvote/',
         toggle_upvote_comment, name='toggle_upvote_comment'),
]
