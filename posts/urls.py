...
urlpatterns = [
    ...
    path('post/<int:pk>/toggle_like/', views.toggle_like_view, name='toggle_like'),
    ...
    path('comment/<int:pk>/toggle_upvote/', views.toggle_upvote_comment, name='toggle_upvote_comment'),
